...
def verify_layout(short, name, expected, actual):
    ...
    if (short,name)==('ErbStG','§ 19'):
        header('ProzentsatzinderSteuerklasseWertdessteuerpflichtigenErwerbs(§10)biseinschließlich…EuroIIIIII',
               'WertdessteuerpflichtigenErwerbs(§10)biseinschließlich…EuroProzentsatzinderSteuerklasseIIIIII',1)
