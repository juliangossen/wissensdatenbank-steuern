...
class Converter:
    ...
    def run(self):
        ...
        self.add('**Historische Fassung:** Dies ist das Solidaritätszuschlaggesetz vom 24. Juni 1991 mit Änderungsstand 25. Februar 1992. Es ist nicht das Solidaritätszuschlaggesetz 1995. Die zeitlichen Anwendungsvorschriften der gelieferten Quelle bleiben maßgeblich.')
